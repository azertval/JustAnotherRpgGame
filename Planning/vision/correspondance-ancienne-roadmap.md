...
|---|---|---|---|
| `LOT-16` | Quêtes et drapeaux de monde | [LOT-116](../versions/v0.1.0/v0.0.1-demo/lots/LOT-116-quetes-et-drapeaux.md) (le mécanisme), [LOT-155](../versions/v0.1.0/v0.0.3-capitale-intra-muros/lots/LOT-155-quete-les-enfants-de-martpart.md) (la quête du livre) | `0.0.1`, `0.0.3` |
| `LOT-17` | Sauvegarde | [LOT-150](../versions/v0.1.0/v0.0.3-capitale-intra-muros/lots/LOT-150-sauvegarde.md) | `0.0.3` |
| `LOT-27` | La Capitale, contenu du *vertical slice* | [LOT-118](../versions/v0.1.0/v0.0.1-demo/lots/LOT-118-combat-sur-la-carte.md) (le combat sur la carte), les lots de zone de la Capitale | `0.0.1` → `0.0.4` |
...
| `LOT-42`, `LOT-70` | Voyage, horloge, calendrier | [LOT-171](../versions/v0.1.0/v0.0.5-abords-de-la-capitale/lots/LOT-171-voyage-et-carte-de-region.md), [LOT-203](../versions/v0.2.0/lots/LOT-203-calendrier-et-lune.md) | `0.0.5`, `0.2.0` |
| `LOT-41`, `LOT-46` | Rencontres, créatures de Tanares | les lots de zone, et [LOT-196](../versions/v0.1.0/v0.1.0-empire-central/lots/LOT-196-hostiles-de-l-empire-revue.md) pour l'Empire ; le reste avec chaque région | `0.0.4` → `0.1.0` |
| `LOT-49` | Contrôle de cohérence du contenu | [LOT-197](../versions/v0.1.0/v0.1.0-empire-central/lots/LOT-197-equilibrage-et-coherence.md) | `0.1.0` |
...
|---|---|---|
| `LOT-90` | Le plan pénombral | la version `0.17.0` entière |
| `LOT-81` | Descripteurs de terrain des treize régions | un lot par région, à l'ouverture de sa version |
| `LOT-44` | Noms, tables aléatoires, contenu d'ambiance | avec les zones qui en ont besoin ; d'abord les villages sans texte (`0.0.7` à `0.0.9`) |
