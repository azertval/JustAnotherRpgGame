...
| R-03 | **Le poids du dépôt.** À 40 Mio par zone, l'Empire pèse 800 Mio, le monde plusieurs gibioctets | git versionne mal le binaire | budget par zone contrôlé en CI (LOT-104) ; décision de stockage à la `0.0.3` (Q-08) ; l'arborescence par région permet de déplacer sans tout casser |
