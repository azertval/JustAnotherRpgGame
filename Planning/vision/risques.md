...
| R-13 | **Une zone livrée sous le standard.** Validée sur pièce, jugée ensuite loin du standard du jeu final, elle se refait | Arenarea (LOT-108, LOT-109) : validée le 24 septembre, à refaire le 25 (D-25) ; le standard du jeu final n'est écrit nulle part avec cette exigence | la démo se joue en cartes de principe, découplée des assets (LOT-146) ; la reprise est un lot (LOT-147) qui écrit au standard ce qui manquait ; « livré » pour une zone exige la relecture de l'auteur sur la galerie **et** le rendu moteur |
