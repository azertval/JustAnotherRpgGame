...
|---|---|---|
| `0.0.1` | **Démo basique** : Arena of Fate, Arenarea, Martpart en 2D HD ; une quête | détaillée, lot par lot |
...
zone HD n'a été produite. La `0.0.1` le donnera pour trois quartiers, la `0.0.3` pour six de plus.
