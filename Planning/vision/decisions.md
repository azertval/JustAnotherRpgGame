...
| D-22 | 21 sept. 2026 | **Une carte se maquette avant de s'habiller** : sa physique (sols, murs, eau, portails, entités, zones) se dessine et se **joue** sans texture, dans l'éditeur comme dans le jeu. Les entités y sont des **jetons ronds** : **vert** le joueur, **jaune** le PNJ de quête, **rouge** l'hostile (LOT-128) | décision de l'auteur — prérendre vite une carte d'un point de vue physique, ajouter les textures après ; la démo se joue de bout en bout pendant que les assets se produisent |
