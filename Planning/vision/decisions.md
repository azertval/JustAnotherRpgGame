...
| D-19 | 21 sept. 2026 | Les lots de l'**éditeur** entrent dans `Planning/`, sous la filière `editeur` et des numéros `LOT-NNN` ; la feuille de route de l'éditeur est close et garde son histoire. Les lots de cartes **déclarent** leurs prérequis d'éditeur | l'[audit de l'éditeur](../standards/audit-editeur.md) : « livré » pour une carte veut dire *dessinée dans l'éditeur*, et l'outil n'était prêt ni pour la HD, ni pour l'arborescence par niveaux, ni pour la quête — une dépendance réelle que rien ne montrait (ancienne Q-12) |
| D-20 | 21 sept. 2026 | **`LOT-EDITOR-11` est abandonné** : il pilotait le générateur du `LOT-40`, écarté. Son besoin réel — semer une forêt sans perdre ses retouches — devient le LOT-168, un outil de dessin | aucun générateur de terrain n'existe dans `Core`, et les cartes se dessinent zone par zone |
| D-21 | 21 sept. 2026 | **Un niveau est une carte.** Les étages et sous-sols d'un lieu se traduisent par des **cartes à part**, reliées par portail (escalier, trappe) ; ni le jeu ni l'éditeur ne jouent d'étages **praticables** dans une même carte — l'étage du LOT-129 (`EX-LVL-025`) est un décor élevé sous lequel on passe, jamais un niveau où l'on monte. L'Arena of Fate compte donc deux cartes dès la démo — le sable, et le niveau −1 des vestiaires et de la prison —, puis une troisième pour les catacombes (LOT-157) | décision de l'auteur (ancienne Q-13) ; conforme à la décision D11 de l'éditeur, dont le format v4 garde la réserve de hauteur sans s'en servir |
| D-22 | 21 sept. 2026 | **Une carte se maquette avant de s'habiller** : sa physique (sols, murs, eau, portails, entités, zones) se dessine et se **joue** sans texture, dans l'éditeur comme dans le jeu. Les entités y sont des **jetons ronds** : **vert** le joueur, **jaune** le PNJ de quête, **rouge** l'hostile (LOT-128) — la couleur se déduit de ce que le format dit déjà, sans propriété nouvelle : jaune au PNJ qui porte un dialogue tant que les drapeaux du LOT-116 n'existent pas | décision de l'auteur — prérendre vite une carte d'un point de vue physique, ajouter les textures après ; la démo se joue de bout en bout pendant que les assets se produisent |
| D-23 | 24 sept. 2026 | **Pas de budget de poids sur les kits d'assets** : une zone, une sous-zone ou un commun se produit aussi riche que le lieu le demande. Le contrôle des 40 Mio par zone (LOT-104) est retiré ; le poids reste pesé et publié, et le plafond de 5 Mio par fichier demeure | décision de l'auteur — « il vaut mieux avoir un jeu lourd mais riche et immersif que de se limiter dans les assets » ; le stockage (Q-08) en devient plus pressant |
| D-24 | 24 sept. 2026 | **Les quêtes s'écrivent dans l'éditeur**, dans un **mode Quêtes** (LOT-144) : drapeaux déclarés, étapes, textes du journal, usages sur les cartes. Les **dialogues** restent écrits en données. L'audit de l'éditeur les tenait tous deux hors de l'outil | décision de l'auteur, en livrant le LOT-126 — une quête ne se relit pas sans les cartes qu'elle traverse, et ses valeurs se tapaient à trois endroits |
