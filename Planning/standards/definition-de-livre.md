...
| Filière | Conditions |
|---|---|
| **Assets HD** | chaque image est au [standard](style-2d-hd.md), citée par un manifeste, visible dans la galerie de débug ; aucune n'est une image du corpus ; les sources sont rangées dans `Tools/AssetsHD/` sous le même arbre |
