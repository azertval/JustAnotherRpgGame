...
prerequis = ["LOT-104", "LOT-112", "LOT-126", "LOT-145", "LOT-147", "LOT-158"]
livrables = [
...
sources = ["Référentiel : Arenarea dans `referentiels/central-empire/`"]
+++
...
`0.0.3`, où il s'inscrit avec les six autres quartiers intra-muros. Dans la démo, le garde et
l'enfant sont tenus par les **mannequins**
...
- **Gustigh Redfield** (CC p. 58) devant son casino — présent, dialogue d'ambiance.
- **Le garde** et **l'enfant** de la quête.
- Neutres : nobles, hauts fonctionnaires, parieurs, domestiques, deux patrouilles Ironhand.
