 ...
 * garantit une seule traduction par terme de règle dans tout le jeu, et
 * `scripts/checks/check_glossary.py` le vérifie. Les disperser en littéraux dans les écrans
 * casserait précisément cette garantie.
 *
