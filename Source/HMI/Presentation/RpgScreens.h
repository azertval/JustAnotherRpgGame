 ...
 * données ; depuis le `LOT-86`, un écran est un formulaire QML
 * (`Source/Ui/Screens/<Nom>Form.ui.qml`) que la pile d'écrans pose quand `hmi::ScreenRouter` le
 * désigne, et il ne reste de la table que cette énumération.
 */
