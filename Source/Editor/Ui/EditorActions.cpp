...
const std::array<CommandSpec, EDITOR_COMMAND_COUNT>& commandSpecs() {
    static const std::array<CommandSpec, EDITOR_COMMAND_COUNT> specs{{
        ...
        {.command = EditorCommand::PlaytestHere,
         ...
         .onToolBar = false,
         .binding = std::nullopt},
        {.command = EditorCommand::RunInGame,
         .label = "Run in game",
         .shortcut = "F5",
         .icon = QStyle::SP_MediaSeekForward,
         .onToolBar = true,
         .binding = std::nullopt},
        {.command = EditorCommand::RunInGameHere,
         .label = "Run in game from hovered cell",
         .shortcut = "Shift+F5",
         .icon = TEXT_ONLY,
         .onToolBar = false,
         .binding = std::nullopt},
        {.command = EditorCommand::RunInGameOptions,
         .label = "Run in game…",
         .shortcut = "Ctrl+F5",
         .icon = TEXT_ONLY,
         .onToolBar = false,
         .binding = std::nullopt},
        {.command = EditorCommand::WorldState,
         .label = "World state…",
         .shortcut = "",
         .icon = TEXT_ONLY,
         .onToolBar = false,
        ...
        {.command = EditorCommand::PasteMirrored,
         .label = "Paste mirrored",
         .shortcut = "Ctrl+Shift+V",
         .icon = TEXT_ONLY,
         .onToolBar = false,
         .binding = std::nullopt},
        {.command = EditorCommand::SaveAsPrefab,
