 ...
 * l'ancre — avec la disposition de la scène (`scene.json`) :
 * `scripts/assetsGeneration/build_hd_mockup.py` écrit les deux d'un même geste, et `--check` garde
 * l'un et l'autre à jour.
 *
 ...
 * voisin, lui, scintillait. `scripts/assetsGeneration/build_hd_mockup.py --travelling <dossier>` en
 * fait une animation.
